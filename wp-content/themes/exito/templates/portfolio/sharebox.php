...
$exito_portfolio_single_sharebox_facebook 	= isset( $exito_options['portfolio_single_sharebox_facebook'] ) ? $exito_options['portfolio_single_sharebox_facebook'] : '1';
$exito_portfolio_single_sharebox_twitter 	= isset( $exito_options['portfolio_single_sharebox_twitter'] ) ? $exito_options['portfolio_single_sharebox_twitter'] : '1';
$exito_portfolio_single_sharebox_linkedin 	= isset( $exito_options['portfolio_single_sharebox_linkedin'] ) ? $exito_options['portfolio_single_sharebox_linkedin'] : '1';
$exito_portfolio_single_sharebox_reddit 	= isset( $exito_options['portfolio_single_sharebox_reddit'] ) ? $exito_options['portfolio_single_sharebox_reddit'] : '1';
$exito_portfolio_single_sharebox_digg 		= isset( $exito_options['portfolio_single_sharebox_digg'] ) ? $exito_options['portfolio_single_sharebox_digg'] : '1';
$exito_portfolio_single_sharebox_delicious 	= isset( $exito_options['portfolio_single_sharebox_delicious'] ) ? $exito_options['portfolio_single_sharebox_delicious'] : '1';
$exito_portfolio_single_sharebox_google 	= isset( $exito_options['portfolio_single_sharebox_google'] ) ? $exito_options['portfolio_single_sharebox_google'] : '1';
$exito_portfolio_single_sharebox_pinterest 	= isset( $exito_options['portfolio_single_sharebox_pinterest'] ) ? $exito_options['portfolio_single_sharebox_pinterest'] : '1';
?>

<div class="sharebox">
	<div class="sharebox_links">
		<?php if( $exito_portfolio_single_sharebox_facebook != '0' ) { ?>
		...
		<?php if( $exito_portfolio_single_sharebox_twitter != '0' ) { ?>
		...
		<?php if( $exito_portfolio_single_sharebox_linkedin != '0' ) { ?>
		...
		<?php if( $exito_portfolio_single_sharebox_reddit != '0' ) { ?>
		...
		<?php if( $exito_portfolio_single_sharebox_digg != '0' ) { ?>
		...
		<?php if( $exito_portfolio_single_sharebox_delicious != '0' ) { ?>
		...
		<?php if( $exito_portfolio_single_sharebox_google != '0' ) { ?>
		...
		<?php if( $exito_portfolio_single_sharebox_pinterest != '0' ) { ?>
