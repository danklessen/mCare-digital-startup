...
<div id="product-images-content" class="clearfix">
	...
	<div class="<?php echo esc_attr( implode( ' ', array_map( 'sanitize_html_class', $wrapper_classes ) ) ); ?>" data-columns="<?php echo esc_attr( $columns ); ?>">
		<figure class="woocommerce-product-gallery__wrapper" id="product-images">
			...
			if ( has_post_thumbnail() ) {
				...
				$html .= sprintf( '<img src="%s" alt="%s" class="wp-post-image" />', esc_url( wc_placeholder_img_src() ), esc_html__( 'Awaiting product image', 'exito' ) );
				$html .= '</div>';
			}
	...
	<?php do_action( 'exito_after_single_product_image' ); ?>
</div>
