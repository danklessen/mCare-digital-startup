	...
	function wbc_extended_example( $demo_active_import , $demo_directory_path ) {
		...
		if ( class_exists( 'RevSlider' ) ) {
			$wbc_sliders_array = array(
				'01_Exito' => array(
					'revslider/home-creative.zip',
					'revslider/home-dark-sryle.zip',
					'revslider/home-default.zip',
					'revslider/home-portfolio.zip',
					'revslider/hove-video.zip',
				),
			);
