...
<div id="redux-header">
	...
	<div class="redux_header_links">
		<a href="http://exito.evatheme.com/docs/" target="_blank"><?php esc_html_e( 'Documentation', 'redux-framework' ); ?></a>
		<a href="http://forum.evatheme.com/" target="_blank"><?php esc_html_e( 'Support Forum', 'redux-framework' ); ?></a>
		<a href="http://www.evatheme.com/themes/" target="_blank"><?php esc_html_e( 'More Themes', 'redux-framework' ); ?></a>
	</div>
